...
async def delete_portfolio(portfolio_id: str, db: DbDep, current_user: CurrentUser) -> None:
    from psx_api.models.users import User
...
@router.post("/{portfolio_id}/transactions/preview", response_model=TransactionPreview)
